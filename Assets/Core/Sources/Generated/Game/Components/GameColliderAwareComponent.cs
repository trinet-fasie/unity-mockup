...
public partial class GameEntity {
    ...
    public TM.ECS.Components.ColliderAwareComponent colliderAware { get { return (TM.ECS.Components.ColliderAwareComponent)GetComponent(GameComponentsLookup.ColliderAware); } }
    public bool hasColliderAware { get { return HasComponent(GameComponentsLookup.ColliderAware); } }

    public void AddColliderAware(TM.Public.IColliderAware newValue) {
        var index = GameComponentsLookup.ColliderAware;
        var component = CreateComponent<TM.ECS.Components.ColliderAwareComponent>(index);
        component.Value = newValue;
        AddComponent(index, component);
    }

    public void ReplaceColliderAware(TM.Public.IColliderAware newValue) {
        var index = GameComponentsLookup.ColliderAware;
        var component = CreateComponent<TM.ECS.Components.ColliderAwareComponent>(index);
        component.Value = newValue;
