...
public partial class GameEntity {
    ...
    public TM.ECS.Components.IdComponent id { get { return (TM.ECS.Components.IdComponent)GetComponent(GameComponentsLookup.Id); } }
    ...
    public void AddId(int newValue) {
        ...
        var component = CreateComponent<TM.ECS.Components.IdComponent>(index);
