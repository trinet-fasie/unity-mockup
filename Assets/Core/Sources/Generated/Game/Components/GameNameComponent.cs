...
public partial class GameEntity {
    ...
    public TM.ECS.Components.NameComponent name { get { return (TM.ECS.Components.NameComponent)GetComponent(GameComponentsLookup.Name); } }
    ...
    public void AddName(string newValue) {
        ...
        var component = CreateComponent<TM.ECS.Components.NameComponent>(index);
