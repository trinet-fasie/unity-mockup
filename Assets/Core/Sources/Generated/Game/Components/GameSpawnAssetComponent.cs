...
public partial class GameEntity {
    ...
    public TM.ECS.Components.Events.SpawnAssetComponent spawnAsset { get { return (TM.ECS.Components.Events.SpawnAssetComponent)GetComponent(GameComponentsLookup.SpawnAsset); } }
    public bool hasSpawnAsset { get { return HasComponent(GameComponentsLookup.SpawnAsset); } }

    public void AddSpawnAsset(TM.Data.SpawnInitParams newSpawnInitParams, int newIdPhoton) {
        var index = GameComponentsLookup.SpawnAsset;
        var component = CreateComponent<TM.ECS.Components.Events.SpawnAssetComponent>(index);
        component.SpawnInitParams = newSpawnInitParams;
        component.IdPhoton = newIdPhoton;
        AddComponent(index, component);
    }

    public void ReplaceSpawnAsset(TM.Data.SpawnInitParams newSpawnInitParams, int newIdPhoton) {
        var index = GameComponentsLookup.SpawnAsset;
        var component = CreateComponent<TM.ECS.Components.Events.SpawnAssetComponent>(index);
        component.SpawnInitParams = newSpawnInitParams;
        component.IdPhoton = newIdPhoton;
