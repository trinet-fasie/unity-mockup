...
namespace TM
{
    public static class GameStateData
    {
        ...
        private static Dictionary<string, string> _customTypesList = new Dictionary<string, string>();
        ...
        public static void AddAssembly(string name, Assembly assembly)
        {
            if (!Assemblies.ContainsKey(name))
            {
                ...
                Debug.Log($"Assembly {name} was added!");
            }
            else
            {
                Assemblies[name] = assembly;
                Debug.Log($"Assembly {name} was updated!");
            }
        }

        public static Assembly GetAssembly(string assemblyName) => Assemblies.ContainsKey(assemblyName) ? Assemblies[assemblyName] : null;
        ...
        public static void AddAssembly(string assemblyKey, string assemplyPath)
        {
            if (_customTypesList.ContainsKey(assemblyKey))
            {
                return;
            }

            _customTypesList.Add(assemblyKey, assemplyPath);
        }
        ...
        public static List<string> GetAssembliesPathes()
        {
            ...
            foreach (string value in _customTypesList.Values)
            {
                pathes.Add(value);
            }
