...
namespace TM
{
    public abstract class Wrapper : DynamicObject
    {
        ...
        public void EnableGrab()
        {
            ...
            foreach (InputController control in controls)
            {
                control.AddGrabStartAction();
                control.AddGrabEndAction();
            }
        }
    ...
    {
        public static void DisableInputUsing(this IWrapperAware self, GameObject go) => self.Wrapper().GetInputController(go)?.DisableInputUsing();
        ...
        public static void DisableInputGrab(this IWrapperAware self, GameObject go) => self.Wrapper().GetInputController(go)?.DisableInputGrab();
        public static void EnableInputGrab(this IWrapperAware self, GameObject go) => self.Wrapper().GetInputController(go)?.EnableInputGrab();
        public static void DisableTouch(this IWrapperAware self, GameObject go) => self.Wrapper().GetInputController(go)?.DisableTouch();
        public static void EnableTouch(this IWrapperAware self, GameObject go) => self.Wrapper().GetInputController(go)?.EnableTouch();
    }
