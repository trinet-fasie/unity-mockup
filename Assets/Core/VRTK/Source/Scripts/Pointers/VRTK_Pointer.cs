...
namespace VRTK
{
    ...
    public class VRTK_Pointer : VRTK_DestinationMarker
    {
        ...
        //TM: over the threshold touchpad input mask to disable the pointer activation for the snap turn action
        [HideInInspector]
...
#pragma warning restore 0618
        ...
        IEnumerator ShowPointerDelayed()
        {
            bool overThresholdOnBegin = overThreshold;
            
            if (!overThresholdOnBegin)
            {
        ...
        IEnumerator HidePointerDelayed()
        {            
