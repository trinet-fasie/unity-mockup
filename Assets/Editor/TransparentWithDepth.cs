...
namespace HighlightPlus {
	...
	public class TransparentWithDepth {
		...
		static void AddDepthOption () {
			...
			if (!EditorUtility.DisplayDialog ("Add Depth To Transparent Object", "This option will force the transparent obejct to write to the depth buffer by adding a new special material to the renderer (existing materials are preserved) so it can occlude and allow See-Through effect.\nOnly use on transparent objects.\n\nProceed?", "Yes", "No")) {
				return;
			}
